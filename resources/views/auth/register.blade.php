                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('avatar') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="avatar" type="file" id="input-file-now-custom-1" name="images" onerror="{{asset('images/conference-icon.png')}}"/>
                        ...
                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control" name="phone" value="{{ old('full_name') }}" required autofocus>

...
@section('title')
    <title>Kursus :: Kumpul Tugas Akhir</title>
@endsection
@section('content')
            ...
            <article style="margin-right: 30px; margin-left: 30px; margin-bottom: 30px; margin-top: 20px">
                <div id="post-93524" class="post-93524 hentry">
                    <div class="info-header">
                        <br>
                        <h1 class="entry-title">Ketentuan Tugas Akhir {{$f->ucourse->package->title}}</h1>
                        <span class="year">
                    ...
                    <div class="entry-content">
                        <div class="main-info"><div class="con">
                                ...
                                <span class="const">
                                    ...
                                    <p>{!! nl2br(e($f->ucourse->package->final_taskdescript)) !!}</p>
                                </span>
                                        @if($f->file == null)
                                        <h3>Upload File</h3>
                                        <form action="{{route('finaltask.custom.store' , ['id'=>$f->id])}}" method="post" enctype="multipart/form-data">
                                            {{csrf_field()}}
                                        ...
                                        @else
                                            ...
                                            @else
                                                <a href="{{route('finaltask.custom.delete',['id'=>$f->id])}}">

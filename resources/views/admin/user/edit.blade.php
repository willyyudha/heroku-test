      ...
      <div class="container-fluid">
          ...
          <div class="row">
              <div class="col-12" style="margin-top: 20px">
                  <div class="card">
                      <div class="card-body">
                          <form action="{{route('store.edit.user' , ['id' => $user -> id])}}" method="get" class="form-material m-t-40">
                              {{csrf_field()}}
                              {{method_field('PUT')}}
                              ...
                              <div class="form-group">
                                  <input type="text" name="email" class="form-control form-control-line" value="{{$user->email}}">
                              </div>
                              <div class="form-group">

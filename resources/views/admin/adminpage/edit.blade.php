    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12" style="margin-top: 20px">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('store.edit.admin' , ['id' => $admin -> id])}}" method="get" class="form-material m-t-40">
                            {{csrf_field()}}
                            {{method_field('PUT')}}
                            ...
                            <div class="form-group">
                                <input type="text" name="name" class="form-control form-control-line" value="{{$admin->name}}">
                            </div>
                            <div class="form-group">
                                <h3>Email</h3>
                            </div>
                            <div class="form-group">
                                <input type="text" name="email" class="form-control form-control-line" value="{{$admin->email}}">
                            </div>
                            <div class="form-group">

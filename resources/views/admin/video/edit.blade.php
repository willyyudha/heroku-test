    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12" style="margin-top: 20px">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('video.update' , ['id'=>$v->id])}}" method="post" enctype="multipart/form-data" class="form-material m-t-40">
                            {{csrf_field()}}
                            {{method_field('PUT')}}
                            ...
                            <div class="form-group">
                                <input type="text" id="name" name="name" class="form-control form-control-line"  value="{{$v->name}}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <select id="paket" name="paket">
                                    @foreach($pk as $d => $i)
                                        <option @if($v->coursepackage->id == $i->id) selected @endif value="{{$i->id}}">{{$i->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                <h4 class="card-title center">Tahap</h4>
                            </div>
                            <div class="form-group">
                                <input type="text" id="tahap" name="tahap" class="form-control form-control-line" value="{{$v->step}}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <textarea id="link" name="link" rows="10" style="width: 100%" cols="100">{{$v->link}}</textarea>
                            </div>
                            <div class="form-group">

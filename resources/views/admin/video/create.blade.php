    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Tambah Video</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-12" style="margin-top: 20px">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('video.store')}}" method="post" enctype="multipart/form-data" class="form-material m-t-40">
                            {{csrf_field()}}
                            <div class="form-group">
                                <h4 class="card-title center">Nama</h4>
                            </div>
                            <div class="form-group">
                                <input type="text" id="name" name="name" class="form-control form-control-line" required autofocus>
                            </div>
                            <div class="form-group">
                                <h4 class="card-title center">Paket Kursus</h4>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <h4 class="card-title center">Urutan</h4>
                            </div>
                            <div class="form-group">
                                <input type="text" id="tahap" name="tahap" class="form-control form-control-line" required autofocus>
                            </div>
                            <div class="form-group">
                                <h4 class="card-title center">Link</h4>
                            </div>
                            <div class="form-group">
                                <textarea type="text" id="link" name="link" class="form-control form-control-line" rows="10" cols="100" required autofocus></textarea>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-success" type="submit">Tambah Video</button>
                            </div>
                        </form>
                    </div>
                </div>

    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Tambah Data Kursus</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-12" style="margin-top: 20px">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('packagecourse.store')}}" method="post" enctype="multipart/form-data" class="form-material">
                            {{csrf_field()}}
                            <div class="form-group">
                                <h4 class="card-title center">Judul</h4>
                            </div>
                            <div class="form-group">
                                <input type="text" id="title" name="title" class="form-control form-control-line" required>
                            </div>
                            <div class="form-group">
                                <h4 class="card-title center">Deskripsi</h4>
                            </div>
                            <div class="form-group">
                                <textarea name="description" id="description" placeholder="Description" rows="10" cols="100"  class="form-control" ></textarea>
                            </div>
                            <div class="form-group">
                                <h4 class="card-title center">Harga</h4>
                            </div>
                            <div class="form-group">
                                <input name="price" id="price" placeholder="price"  class="form-control" >
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <h4 class="card-title center">Image</h4>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button class="btn btn-success" type="submit">Tambah Kursus</button>
                            </div>
                        </form>
                    </div>
                </div>

...
@section('search-bar')
    <li class="nav-item hidden-sm-down search-box"> <a class="nav-link hidden-sm-down text-muted waves-effect waves-dark" href="javascript:void(0)"><i class="ti-search"></i></a>
        <form class="app-search" action="{{route('othertaskuser.index3.search')}}" method="GET">
            {{csrf_field()}}
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Daftar Belum Lolos</h3>
            </div>
        </div>
        <!-- ============================================================== -->
                            ...
                            <table id="myTable" class="table table-bordered table-striped">
                                ...
                                @forelse($qz as $u => $i)
                                    <tr>
                                        ...
                                        <th>{{$i->quiz->video->coursepackage->title}}</th>
                                        <th>{{$i->user->email}}</th>
                                        <th>{{$i->user->phone}}</th>
                                        <th><a href="{{route('othertask.showcustom.userquiz',['id'=>$i->id])}}"><button class="btn-sm btn-info">Detail</button></a></th>
                                    </tr>
                                @empty
                                    <tr>
                                        <th colspan="9">

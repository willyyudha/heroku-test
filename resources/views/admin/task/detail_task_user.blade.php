    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Tugas Akhir Kursus {{$cp->title}}</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-12" style="margin-top: 20px">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('taskuser.update',['id'=>$cp->id])}}" method="post" enctype="multipart/form-data" class="form-material m-t-40">
                            {{csrf_field()}}
                            {{method_field('PUT')}}
                            <div class="form-group">
                                <h4 class="card-title center">Deskripsi Tugas Akhir</h4>
                            </div>
                            <div class="form-group">
                                <textarea name="descript" id="descript" placeholder="Deskripsi" rows="10" cols="100"  class="form-control">{{$cp->final_taskdescript}}</textarea>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-success" type="submit">Simpan Perubahan</button>&nbsp;
                                <a class="btn btn-danger" href="{{route('task.custom.destroy',['id'=>$cp->id])}}">Hapus Tugas Akhir</a>
                            </div>
                        </form>
                    </div>
                </div>

    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Tambah Tugas Akhir Kursus {{$cp->title}}</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-12" style="margin-top: 20px">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('task.custom.store',['id'=>$cp->id])}}" method="get" enctype="multipart/form-data" class="form-material m-t-40">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                <button class="btn btn-success" type="submit">Tambah Tugas Akhir</button>
                            </div>
                        </form>
                    </div>
                </div>

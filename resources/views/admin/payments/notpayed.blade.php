...
@section('search-bar')
    <li class="nav-item hidden-sm-down search-box"> <a class="nav-link hidden-sm-down text-muted waves-effect waves-dark" href="javascript:void(0)"><i class="ti-search"></i></a>
        <form class="app-search" action="{{route('search.notpayed')}}" method="GET">
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Daftar Belum Bayar</h3>
            </div>
        </div>
        <!-- ============================================================== -->
                            ...
                            <table id="myTable" class="table table-bordered table-striped">
                                ...
                                @forelse($uc as $d => $i)
                                    <tr>
                                        ...
                                        <th>
                                            <a href="{{route('payed' , ['id'=>$i->id])}}"><button class="btn btn-outline-info">Sudah Lunas</button></a>
                                        </th>
                                        <th>
                                            <a class="btn btn-danger" href="{{route('delete.notpayed' , ['id'=>$i->id])}}">Hapus</a>
                                        </th>
                                    </tr>
                                @empty
                                    <tr>

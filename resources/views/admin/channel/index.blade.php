            ...
            @section('search-bar')
                <li class="nav-item hidden-sm-down search-box"> <a class="nav-link hidden-sm-down text-muted waves-effect waves-dark" href="javascript:void(0)"><i class="ti-search"></i></a>
                    <form class="app-search" action="{{route('page.search.channels.superadmin')}}" method="get">
                        {{csrf_field()}}
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-5 col-8 align-self-center">
                            <h3 class="text-themecolor m-b-0 m-t-0">Daftar Chanel</h3>
                        </div>
                    </div>
                    <!-- ============================================================== -->
                                        ...
                                        <table id="myTable" class="table table-bordered table-striped">
                                            ...
                                            @foreach($channels as $channel => $i)
                                                <tr>
                                                    <th>{{$channel+1}}</th>
                                                    <th>{{$i->title}}</th>
                                                    <th><button class="btn btn-info"><a style="color: white" href="{{route('channels.edit', [$i])}}">Ubah</a></button></th>
                                                    <th>
                                                        <form action="{{route('channels.destroy', ['channel' => $i -> id])}}" method="post">
                                                              {{csrf_field()}}
                                                              {{method_field('DELETE')}}

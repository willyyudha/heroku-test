    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Tambah Data Chanel</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12" style="margin-top: 20px">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('channels.store')}}" method="post" class="form-material">
                            {{csrf_field()}}
                            <div class="form-group">
                                <h4 class="card-title center">Judul</h4>
                            </div>
                            <div class="form-group">
                                <input type="text" id="title" name="title" class="form-control form-control-line">
                                @if ($errors->has('title'))
                            ...
                            <div class="form-group">
                                <button class="btn btn-success" type="submit">Add Channel</button>
                            </div>
                            {{--<div class="form-group">--}}

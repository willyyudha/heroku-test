      ...
      <div class="container-fluid">
          ...
          <div class="row">
              <div class="col-12" style="margin-top: 20px">
                  <div class="card">
                      <div class="card-body">
                          <form action="{{route('channels.update' , ['channel' => $channel -> id])}}" method="post" class="form-material">
                              {{csrf_field()}}
                              {{method_field('PUT')}}
                              ...
                              <div class="form-group">
                                  <input type="text" name="title" class="form-control form-control-line" value="{{$channel->title}}">
                                  @if($errors->has('title'))

        ...
        {{--<div class="tp-banner" >--}}
            {{--<ul>--}}
                ...
                {{--<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >--}}
                    {{--<!-- MAIN IMAGE -->--}}
                    {{--<img src="{{asset('images/skripsi-1.jpg')}}"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">--}}
                    {{--<!-- LAYERS -->--}}
                {{--</li>--}}
            {{--</ul>--}}
        {{--</div>--}}
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-9 col-sm-5 col-md-3 selecttopic">
                    {{--<div class="dropdown">--}}
                    @if(Auth::check())
                        {{--<a data-toggle="dropdown" href="#"> <button class="btn btn-primary">Kursus Online <b class="caret"></b></button></a>--}}
                ...
                <div class="col-lg-4 search col-xs-12 col-sm-5 col-md-3">
                    <div class="wrap">
                        @if(Auth::check())
                        <form action="{{route('diskusi.home.cari')}}" method="GET" class="form">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <div class="sidebarblock">
                        <h3 style="font-weight: bold">Chanel Topik</h3>
                        <div class="divline"></div>
                        @if(Auth::check())
                            <div class="blocktxt" style="word-wrap: break-word">
                                <ul class="cats">
                                    @foreach($channels as $channel => $i)
                                <li>{{$channel+1}}. <a href="{{Route('discuss.channel.sort' , ['id'=>$i->id])}}">{{$i->title}}<span class="badge pull-right">{{$i->discussions->count()}}</span></a>
                                    @endforeach
                                </ul>
                            </div>
                        @endif
                ...
                <!-- -->
                    ...
                    <div class="sidebarblock">
                        <h3 style="font-weight: bold">Kategori Topik</h3>
                        <div class="divline"></div>
                        @if(Auth::check())
                            <div class="blocktxt" style="word-wrap: break-word">
                                <ul class="cats">
                    ...
                    <div class="sidebarblock">
                        <h3 style="font-weight: bold"> <a href="{{route('sortbyuser')}}">Topik Saya</a>@if(Auth::check())<a href="{{route('all.user.topic')}}" class="pull-right">Lihat semua</a>@endif</h3>
                        <div class="divline"></div>
                        @if(Auth::check())
                            <div class="blocktxt" style="word-wrap: break-word">
                                @forelse(Auth::user()->discussions->slice(0,5)->sortBy('created_at') as $d => $i )
                                    <ul class="cats">
                                        <li> {{$d+1}}. <a href="{{route('discussions.show' , ['id' => $i -> id])}}">{{$i->title}}</a></li>
                                    </ul>
                                @empty
                                    <ul class="cats">
                                        <li>Tidak Ada Topik</li>
                                    </ul>
                                @endforelse
                            </div>
                        @endif
